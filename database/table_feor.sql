...
--
-- Dumping data for table `feor`
--

INSERT INTO `occupations` (`feor_id`, `name`, `description`) VALUES
(110, 'Fegyveres szervek felsőfokú képesítést igénylő foglalkozásai', ''),
(210, 'Fegyveres szervek középfokú képesítést igénylő foglalkozásai', ''),
(310, 'Fegyveres szervek középfokú képesítést nem igénylő foglalkozásai', ''),
...
(3717, 'Kulturálisintézményi szaktechnikus', ''),
...
(8123, 'Bőrkikészítő- és -feldolgozó gépkezelő és gyártósor mellett dolgozó', ''),
...
(8322, 'Vízgazdálkodási gépkezelő', ''),
(8323, 'Kazángépkezelő', ''),
...
(8421, 'Mezőgazdasági, erdőgazdasági, növényvédő gépkezelő', ''),
